 ...
 * @author Johnny Zhu
 */
public class test implements BadugiPlayer
{
    ...
    public test() { this.id = ++count; }
    public test(String nick) { this.nick = nick; }
...
//    	}else if(currentScore<-100000000){
//    		prints2("LOSING BY 100 BUCKS");
//    		
//    		return playStyleAggressive(drawsRemaining, hand, bets, pot, toCall, opponentDrew);   		
//    		
    	}
//
//    	else{
...
//		    	}else if (discardHand.size() > opponentDrew){
//		    		
////		    		if(ran < .5) { weBluffing =true;shouldWeDraw = false;return betRaise; }
////		    		if(ran < .9) { weBluffing =true;shouldWeDraw = false;return betRaise; }
//		    		return foldCheck;
//		    	}
			    return foldCheck;
