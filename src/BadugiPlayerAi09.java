 ...
 * @author Johnny Zhu
 */
public class BadugiPlayerAi09 implements BadugiPlayer
{
    private static int count = 0;
    private int id;
    private String nick = "Donald Trump 09";
   ...
   private double bluff_02_rngValue=0.5;
    ...
    public BadugiPlayerAi09() { this.id = ++count; }
    public BadugiPlayerAi09(String nick) { this.nick = nick; }
...
//    	}
    ...
    //	prints3("bluff_01_rngValue +bluff_02_rngValue "+bluff_01_rngValue+"|"+ bluff_02_rngValue);
    	prints3("bluff_01_rngValue "+bluff_01_rngValue);
    	prints3("bluff_02_rngValue "+bluff_02_rngValue);
...
//    		prints2("------------------");
    		...
    		prints3("|player_win= "+player_win+"|player_loss= "+player_loss+"|player_tie= "+player_tie+"|     " +"bluff win= "+player_bluff_win+"|bluff loss= "+player_bluff_loss);
...
//    	double ran = rng.nextDouble();
    ...
    public int playStyleStandard(int drawsRemaining, BadugiHand hand, int bets, int pot, int toCall, int opponentDrew){
    	...
    	if (weBluffing ==true){
    		...
    		if (toCall==8)
    		{
    			prints3("they called us" +toCall+"|"+bets);
    			return foldCheck;
    		}
    		prints2("we bluffing");
    		shouldWeDraw = false;
...
//	    			if(ran < bluff_01_rngValue) { weBluffing =true;bluff_01_inUse=true;shouldWeDraw = false;prints3("bluff baby1");return betRaise; }
	    			if(ran < 0) { weBluffing =true;bluff_01_inUse=true;shouldWeDraw = false;prints3("bluff baby1");return betRaise; }
...
//		    			if(ran < bluff_02_rngValue) { weBluffing =true;bluff_02_inUse=true;shouldWeDraw = false;prints3("bluff baby2");return betRaise; }
		    			if(ran < 0) { weBluffing =true;bluff_01_inUse=true;shouldWeDraw = false;prints3("bluff baby1");return betRaise; }
		    		}
