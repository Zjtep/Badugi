 ...
 * @author Johnny Zhu
 */
public class BadugiPlayerAi10 implements BadugiPlayer
{
    private static int count = 0;
    private int id;
    private String nick = "Jay -Z";
   ...
   private double bluff_02_rngValue=0.5;
    ...
    public BadugiPlayerAi10() { this.id = ++count; }
    public BadugiPlayerAi10(String nick) { this.nick = nick; }
